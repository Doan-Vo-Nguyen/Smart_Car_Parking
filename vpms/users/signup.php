...
if (isset($_POST['submit'])) {
    ...
    if ($result > 0) {
        ...
        $query = mysqli_query($con, "INSERT INTO tblregusers(FullName,Birth, MobileNumber, CCCD, Email, Password) value('$fname', '$birth', '$contno', '$cccd' , '$email', '$password' )");
        if ($query) {
            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    <form method="post" onsubmit="return checkpass();">
                        ...
                        <div class="form-group">
                            <label>Birth</label>
                            <input type="date" name="birth" placeholder="Choose birth" required="true" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>CCCD</label>
                            <input type="text" name="cccd" placeholder="CCCD" required="true" class="form-control">
                        </div>
                        <div class="form-group">
