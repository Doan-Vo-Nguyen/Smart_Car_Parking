    ...
    <body>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="chart-toggle">
                                    ...
                                    <button id="lineChartBtn" class="btn btn-secondary">Show Financial Report</button>
                                </div>
                                <?php
                                // Fetching vehicle parking data by date
                                $query = "SELECT DATE(InTime) as date, COUNT(*) as vehicle_count FROM tblvehiclelogs GROUP BY DATE(InTime)";
                                ...
                                $financialQuery = "SELECT DATE(InTime) as date, SUM(ParkingCharge) as total_charge FROM tblvehiclelogs GROUP BY DATE(InTime)";
        ...
        <script>
            ...
            function renderLineChart() {
                var chart = new CanvasJS.Chart("chartContainer", {
                    ...
                    data: [{
                        ...
                        xValueType: "dateTime",
                        dataPoints: <?php echo json_encode($financialDataPoints, JSON_NUMERIC_CHECK); ?>
                    }]
                });
            ...
            document.getElementById('barChartBtn').addEventListener('click', function() {
                ...
                document.getElementById('lineChartBtn').classList.add('btn-secondary');
            });
