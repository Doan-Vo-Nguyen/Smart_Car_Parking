...
if (strlen($_SESSION['vpmsaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "insert into  tblvehicle(ParkingNumber,VehicleCategory,RegistrationNumber,OwnerName) value('$parkingnumber','$catename','$vehcomp','$vehreno','$ownername','$ownercontno')");
        if ($query) {
